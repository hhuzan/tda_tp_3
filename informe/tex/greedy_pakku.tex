...
En total se realizaron mediciones para $17*3=51$ conjuntos distintos de habilidades, cada
uno con entre 200 y 1000 elementos.:

\begin{itemize}
  \item Se generó un conjunto de datos con sets de tamaño variable con entre 200 y 1000 elementos (habilidades).
...
Se observa que, si bien hay elevada dispersion en los resultados, los valores medidos se ajustan bien
...
Backtraking. Como se vio en gráfico anterior, siguen un orden $n.log(n)$
