...
En esta sección se planteará un modelo de Programación Lineal para la resolucion de este problema. 
...
\begin{itemize}
    ...
    \item $Z_{\max}, Z_{\min} \in \mathbb{R}$: valores máximo y mínimo, respectivamente, entre todas las sumas $s_i$.
\end{itemize}
...
\begin{itemize}
    ...
    Lo principal será limitar a cuántos grupos $i$ puede pertenecer cada maestro $j$. En este caso se busca que cada maestro esté asignado a un solo grupo, por lo tanto tendremos una restricción tal que:
...
\subsection{Implementacion en PuLP}

\lstinputlisting[language=Python]{../lineal_pakku.py}
