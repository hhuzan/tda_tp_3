...
Se analizará de qué manera varía la optimalidad de los resultados de este modelo. Para ello, se tomaron mediciones con conjuntos de datos aleatorios. Para simplificar el tiempo de procesamiento, se generaron datos con $n \leq 14$ y $k = 5$.
